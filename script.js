...
if (footerWhatsapp) { footerWhatsapp.href = wa("Hola, contacto desde la web de Papeamigos. Quiero asistencia o más información del sistema."); footerWhatsapp.target = "_blank"; footerWhatsapp.rel = "noopener"; }
